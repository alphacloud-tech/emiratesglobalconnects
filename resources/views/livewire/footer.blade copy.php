                ...
                <div class="col-lg-3 col-md-6">
                    <div class="ft-footer-widget ul-li-block headline pera-content">
                        <div class="logo-widget">
                            ...
                            <div class="ft-btn">
                                <a class="d-flex justify-content-center align-items-center" href="{{ route('contact.page') }}">Get In Touch</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ft-footer-widget ul-li-block headline pera-content">
                        <div class="gallery-widget clearfix">
                            ...
                            <ul class="zoom-gallery">
                                ...
                                <li>
                                    <a href="{{ asset($item->image_url) }} " data-source="{{ asset($item->image_url) }} ">
