                                ...
                                <div class="list-group">
                                    ...
                                    <a href="javascript:void()"
                                        ...
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-3">Logo Dark</h5>
                                        </div>
                                        <p class="mb-1 float-left">
                                            <img class="card-img-top img-fluid" src="{{ asset($setting->logo) }}"
                                                alt="Card image cap">
                                        </p>
                                    </a>
                            ...
                            <div class="basic-list-group">
                                <div class="list-group">
                                    ...
                                    <a href="javascript:void()"
                                        class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-3">Logo Light</h5>
                                        </div>
                                        <p class="mb-1 float-left">
                                            <img class="card-img-top img-fluid" src="{{ asset($setting->logo2) }}"
                                                alt="Card image cap">
                                        </p>
                                    </a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="basic-list-group">
                                <div class="list-group">
                                    ...
                                    <a href="javascript:void()"
                                        class="list-group-item list-group-item-action flex-column align-items-star">
                                        <div class="d-flex w-100 justify-content-between">
