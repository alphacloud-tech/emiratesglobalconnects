...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">What Make Us Special</h4>
                                    ...
                                    <div class="modal fade" id="editModalCenter{{ $item->id }}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="{{ route('special.update', $item->id) }}" method="POST"
                                                    ...
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Edit What Make Us Special</h5>
                                    ...
                                    <div class="modal fade" id="deleteModalCenter{{ $item->id }}" aria-hidden="true"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Delete What Make Us Special</h5>
                                                    <button type="button" class="close"
                                                        data-dismiss="modal"><span>×</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="{{ route('special.destroy', $item->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('special.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Create What Make Us Special</h5>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.success) {
                                if (isChecked) {
                                    Swal.fire('Success',
                                        'What Make Us Special activated successfully.',
                                        'success');
                                } else {
                                    Swal.fire('Success',
                                        'What Make Us Special deactivated successfully.',
                                        'success');
                                }
                            } else {
                                Swal.fire('Error',
                                    'Error updating What Make Us Special status.',
                                    'error');
                            }
                        },
                        error: function() {
